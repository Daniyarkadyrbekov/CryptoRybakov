...
extension GameScene{
    func createBird() -> SKSpriteNode {
        ...
        bird.size = CGSize(width: 90, height: 70)
    ...
    func createHighscoreLabel() -> SKLabelNode {
        ...
        highscoreLbl.position = CGPoint(x: 60, y: 22)
        ...
        highscoreLbl.fontName = "Minecraft"
    ...
    func createTaptoplayLabel() -> SKLabelNode {
        ...
        taptoplayLbl.text = "Нажми, и погнали за криптой ;)"
        taptoplayLbl.fontColor = UIColor(red: 63/255, green: 79/255, blue: 145/255, alpha: 1.0)
        taptoplayLbl.zPosition = 5
        taptoplayLbl.fontSize = 15
        taptoplayLbl.fontName = "Minecraft"
        return taptoplayLbl
    }
